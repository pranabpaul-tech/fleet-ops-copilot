...
class Settings(BaseSettings):
    ...
    subscription_id: str = ""
    resource_group: str = "rg-fleet-ops-copilot"
    location: str = "westus"

    fabric_capacity_name: str = "fleetopsf8"
    workspace_name: str = "fleet-ops-copilot"

    eventhouse_name: str = "fleetops-eventhouse"
    kql_database_name: str = "fleetops-kql-db"
    table_name: str = "BusTelemetry"

    eventstream_name: str = "fleet-eventstream"

    ops_agent_name: str = "Fleet Operations Monitor"

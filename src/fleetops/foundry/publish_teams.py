#!/usr/bin/env python
"""Publish the Fleet Incident Agent to Microsoft Teams — the REST flow for a
...
from fleetops.foundry._rest import FoundryAgentRest
...
def main() -> None:
    ...
    parser.add_argument("--developer-name", default="Fleet Ops", help="Max 32 chars.")
    parser.add_argument("--short-description", default="Investigate fleet telemetry alerts and take approved action.")

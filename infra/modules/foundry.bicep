...
param aiServicesBaseName string = 'fleetopsai'

param firstProjectName string = 'fleet-incident'
param projectDisplayName string = 'Fleet Incident Agent project'
param projectDescription string = 'Fleet Incident Agent — conversational investigator for the Fleet Ops Copilot'
...
// 'fleet-incident4fgm', not the bare 'fleet-incident' param value. Bicep's
